...
SELECT DISTINCT PM.COMMENT_CONTENT, PM.DATE_OF_COMMENT, PM.IMAGE_COMMENT_URL, U.USER_ID, U.FULL_NAME, U.AVATAR_URL, RP.RATE_NUMBER
FROM PRODUCT AS P 
		JOIN PRODUCT_COMMENT AS PM ON P.PRODUCT_ID = PM.PRODUCT_ID
        JOIN RATE_PRODUCT AS RP ON RP.PRODUCT_ID = PM.PRODUCT_ID
		JOIN USER AS U ON RP.USER_ID = U.USER_ID 		
