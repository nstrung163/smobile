...
<head>
    ...
    <title>Trang chủ | Thống Kê Sản Phẩm</title>
...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table mr-1"></i> Thông tin thống kê sản phẩm
                        </div>
                        <div class="card-body">
    ...
    <script src="<c:url value='/js/admin/product-statistic.js'/>"></script>
</body>
</html>