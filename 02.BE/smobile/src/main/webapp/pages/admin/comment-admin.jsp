...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol  class="breadcrumb mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active">Đánh giá & Bình luận</li>
                    </ol>
                    <h3>Quản Lý Đánh Giá & Bình Luận</h3>
                    <!-- Alert -->
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table mr-1"></i> Thông tin đánh giá & bình luận
                        </div>
                        <div class="card-body">
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Bạn có muốn xóa bình luận <b id="deleteCommentId"></b>?</p>
							</div>
    ...
    <script src="<c:url value='/js/admin/comment-admin.js'/>"></script>
</body>
</html>