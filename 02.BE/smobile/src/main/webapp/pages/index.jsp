          ...
          <div class="row">
            <div class="txt-banner d-flex">
              <ul class="txt-banner__list">
                ...
                <li>
                  <a href="/" class="txt-banner__list--item bd-left">Samsung Galaxy S21 Ultra 5G ưu đãi đến 34%</a>
                </li>
                <li>
                  <a href="/" class="txt-banner__list--item bd-left">Samsung Galaxy S21 Plus 5G giảm 30%</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section class="row">
            ...
            <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="<c:url value='/images/carousel/carousel1.png'/>"/>
                </div>
          ...
          <div class="hotnew">
            <div class="experience-video">
              <h2 class="experience-video-heading"><a href="/">Tin tức</a></h2>
              <ul>
                <li>
                ...
                <ul class="product-promo__list">
                  ...
                  <li class="product-promo--item">
                    <a href="/">
                      ...
                      <div class="img-label">
                        <img src="/images/product/online-giảm-sốc-1x.png" alt="Gia soc" />
                      </div>
                ...
                <ul class="product-promo__list">
                  ...
                  <li class="product-promo--item">
                    <a href="/">
                      <div class="img-container">
                        <span class="tra-gop">Trả góp 0%</span>
                        <img src="/images/product/gstc7.jpg" alt=""/>
                      </div>
                      <div class="img-label">
                        <img src="/images/product/online-giảm-sốc-1x.png" alt="Gia soc"/>
                      </div>
                  ...
                  <li class="product-promo--item product-promo--item-type2">
                    <a href="/">
                      <div class="img-container">
                        <span class="tra-gop">Trả góp 0%</span>
                        <img src="/images/product/gstc8.jpg" alt=""/>
                      </div>
                      <div class="img-label">
                        <img src="/images/product/online-giảm-sốc-1x.png" alt="Gia soc"/>
                      </div>
                      <p class="product-name">Samsung Inverter 8.5 Kg</p>
                      <strong class="product-price-old">12.990.000₫ </strong>
                      <div class="product-price-sale">
                        <span class="product-sale">
                          Online giảm <span class="percent-sale">23%</span> còn:
